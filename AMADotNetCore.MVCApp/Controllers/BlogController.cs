...
namespace AMADotNetCore.MVCApp.Controllers
{
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> BlogSave(BlogDataModel blog)
        {
            ...
            TempData["Message"] = result > 0 ? "Saving Success." : "Saving Failed."; 
        ...
        public async Task<IActionResult> BlogUpdate(int id,BlogDataModel blog)
        {
            ...
            var result = await _context.SaveChangesAsync();
            TempData["IsSuccess"] = result > 0;
            TempData["Message"] = result > 0 ? "Updating Success." : "Updating Failed.";
            return Redirect("/Blog");
        }
        ...
        public async Task<IActionResult> BlogDelete(int id)
        {
            ...
            var result = await _context.SaveChangesAsync();
            TempData["IsSuccess"] = result > 0;
            TempData["Message"] = result > 0 ? "Deleting Success." : "Deleting Failed.";
            return Redirect("/Blog");
        }
    }
}
